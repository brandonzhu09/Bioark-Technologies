...
export class LandingPageService {
  ...
  productsData = [
    { name: 'Targeted Knock-In', description: 'The product offers a tool for integrating target genes or regulatory cassettes into designated safe harbor sites, such as AAVS1, CCR5.', link: '/products/overexpression', image: '../../assets/Product-1 Overexpression Targeted Knock-In.jpg' },
    { name: 'Knock-In Tagging', description: 'The product offers versatile options for attaching selected tags to the 3\' and 5\' ends of target genes.', link: 'products/gene-knock-in', image: '../../assets/Product-2 Gene Knock-In Tagging.jpg' },
    ...
    { name: 'RNA Knock-down', description: 'The product  offers a more specific and potent alternative to traditional RNAi methods for knocking down RNA expression levels.', link: 'products/rna-knock-down', image: '../../assets/Product-5 CRISPR RNA Knock-Down.jpg' }
  ]
  ...
  servicesData = [
    ...
    { name: 'Lab Supplies', description: 'We offer stable cell line construction tailored to various requirements across different cancer cell lines and adherent cell lines at a relatively affordable price. Our services include gene overexpression, knockout, knock-in, and deletion.', link: '/services/stable-cell-line', image: '../../assets/Service-5 Lab Supplies.png' },
  ]
